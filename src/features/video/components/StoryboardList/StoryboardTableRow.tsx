...
type StoryboardTableRowProps = {
  ...
  onRegenerate?: (storyboardId: string) => void
        ...
        <td className={tableStyles.colActions}>
          <div className={styles.actionGroup}>
            ...
            <button
              type="button"
              className={styles.actionBtn}
              title={!storyId ? "缺少 storyId，无法重新生成" : regenerating ? "重新生成中…" : "重新生成（脚本/提示词/参考图）"}
              aria-label="重新生成"
              disabled={!storyId || Boolean(regenerating) || !onRegenerate}
